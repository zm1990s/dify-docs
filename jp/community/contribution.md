...
> 注意：新しいツールを提供したい場合は、必ずツールの YAML 説明ページに連絡先情報を残し、[Dify-docs](https://github.com/langgenius/dify-docs/tree/main/en/guides/tools/tool-configuration) ヘルプドキュメントのコードリポジトリに対応するPRを提出してください。
