...
<figure><img src="../../.gitbook/assets/image (374) (1).png" alt=""><figcaption><p>高质量模式</p></figcaption></figure>
{% endtab %}
...
这是因为问题文本**通常是具有完整语法结构的自然语言**，Q to Q 的模式会令语意和匹配更加清晰，并同时满足一些高频和高相似度问题的提问场景。
